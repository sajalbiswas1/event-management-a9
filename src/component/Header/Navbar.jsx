        ...
        <div className=''>
            <div className="navbar bg-base-100 w-10/12 m-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <NavLink to={'/shop'}><p className="text-xl font-medium mr-5 px-5 py-2 rounded-lg hover:bg-slate-100">shop</p></NavLink>
                        </ul>
                    </div>
                ...
                <div className="navbar-end">
                    {
                        user ? <>
                            <img className='w-12 h-12 mr-4 rounded-full' src={user ? user?.photoURL : DefaultUserPic} alt="" />
